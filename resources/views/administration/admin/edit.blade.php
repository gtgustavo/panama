        ...
        <div class="tray tray-center">
            ...
            <div class="panel mb25 mt5">
                ...
                <div class="panel-heading">
                    <span class="panel-title hidden-xs"> {!! trans('front.form.administrator.events.edit') !!} - {{ $employee->people->full_name }}</span>
                </div>
                ...
                <div class="panel-body p25 pb5">
                    ...
                    <div class="tab-content pn br-n admin-form">
                        ...
                        {!! Form::model($employee->toArray() + $people->toArray(), ['route' => ['administrator_update', $employee, $people], 'method' => 'PUT']) !!}
